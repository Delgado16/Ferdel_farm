...
try:
    ...
    cursor.execute("""
        SELECT mi.ID_Movimiento, cm.Descripcion as Tipo, cm.Letra, cm.Adicion, mi.ID_Bodega, dmi.ID_Producto, dmi.Cantidad
        ...
        WHERE dmi.Cantidad < 0
        LIMIT 15
    """)
    print("\n=== MOVEMENTS WITH NEGATIVE QUANTITIES ===")
